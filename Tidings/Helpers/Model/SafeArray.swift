...
extension SafeArray {
	...
	/// - Returns: The first element of the sequence that satisfies predicate, or nil if there is no
	/// element that satisfies predicate.
	...
	/// - Parameter predicate: A closure that takes an element of the sequence as its argument and
	/// returns a Boolean value indicating whether the element is a match.
	/// - Returns: The last element of the sequence that satisfies predicate, or nil if there is no
	/// element that satisfies predicate.
	...
	/// in the collection satisfy the given predicate, returns nil.
	...
	/// Returns an array containing the non-nil results of calling the given transformation with
	...
	///   - nextPartialResult: A closure that combines an accumulating value and an element of the sequence into
	///   a new accumulating value, to be used in the next call of the nextPartialResult closure or returned to the caller.
	...
	///
	/// - Parameter predicate: A closure that takes an element of the sequence and returns a Boolean indicating match.
...
extension SafeArray {
	...
	///
	/// - Parameters:
	///   - predicate: A closure that takes an element of the sequence and returns a Boolean indicating match.
